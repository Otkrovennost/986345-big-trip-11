...
/* harmony import */ var _models_store_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/store.js */ "./src/models/store.js");
...
class API {
  ...
  getData() {
    ...
    return Promise.all(requests)
      ...
      .then((responses) => {
        ...
        _models_store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setDestinations(destinations);
        _models_store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setOffers(offers);
        return points;
      })
  ...
  getDestinations() {
    return this._load({url: `destinations`})
      .then((response) => response.json())
      .then(_models_store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setDestinations);
  }

  getOffers() {
    return this._load({url: `offers`})
      .then((response) => response.json())
      .then(_models_store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setOffers);
  }
...
const createCardTemplate = (date, index) => {
  ...
  if (date && index) {
    const fullDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY-MM-DDThh:mm`);
    const month = moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`MMM`);
    const day = moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`DD`);
...
/* harmony import */ var _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../controllers/point-controller.js */ "./src/controllers/point-controller.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _models_store_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../models/store.js */ "./src/models/store.js");
...
const createEditEventTemplate = (point, options) => {
  ...
  if (point === _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_6__["EmptyPoint"]) {
    creatingPoint = true;
  }

  const cities = _models_store_js__WEBPACK_IMPORTED_MODULE_8__["default"].getDestinations().map((destination) => destination.name);

  const startDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(start).format(`DD/MM/YY HH:mm`);
  const endDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(end).format(`DD/MM/YY HH:mm`);
  const typeTransport = getTypeTransport(_const_js__WEBPACK_IMPORTED_MODULE_7__["routeTypes"][0]);
  const typeActivity = getTypeActivity(_const_js__WEBPACK_IMPORTED_MODULE_7__["routeTypes"][1]);
    ...
    `<form class="trip-events__item event event--edit" action="#" method="post">
      ...
      <input class="visually-hidden" name="event-current-type" id="event-current-type-name" value="${type}">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["getUpperCaseFirstLetter"])(type)} ${_const_js__WEBPACK_IMPORTED_MODULE_7__["actionByTypeToPlaceholder"][Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["getUpperCaseFirstLetter"])(type)]}
          </label>
...
class EventEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  constructor(point) {
    super();
  ...
  _subscribeOnEvents() {
    ...
    element.querySelector(`.event__type-list`).addEventListener(`change`, (evt) => {
      ...
      this._offers = _models_store_js__WEBPACK_IMPORTED_MODULE_8__["default"].getOffers().find((offer) => offer.type === this._type).offers;
    ...
    element.querySelector(`.event__input--destination`).addEventListener(`change`, (evt) => {
      ...
      this._photos = _models_store_js__WEBPACK_IMPORTED_MODULE_8__["default"].getDestinations().find((destination) => destination.name === this._city).pictures;
      this._description = _models_store_js__WEBPACK_IMPORTED_MODULE_8__["default"].getDestinations().find((destination) => destination.name === this._city).description;

      this.rerender();
    });

    element.querySelector(`.event__input--price`).addEventListener(`input`, (evt) => {
      evt.target.value = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["clearString"])(evt.target.value);
    });
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(element.querySelector(`#event-start-time-1`), Object.assign({}, options, {defaultDate: this._point.start}));

    this._flatpickrEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(element.querySelector(`#event-end-time-1`), Object.assign({}, options, {defaultDate: this._point.end}));
...
const createEventTemplate = (point) => {
  ...
  const offersList = getOffers(offers);
  const startDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(start).format(`YYYY-MM-DDThh:mm:ss`);
  const endDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(end).format(`YYYY-MM-DDThh:mm:ss`);
  const startTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(start).format(`HH:mm`);
  const endTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(end).format(`HH:mm`);
  const durationTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getDurationTime"])(end - start);
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getUpperCaseFirstLetter"])(type)} ${_const_js__WEBPACK_IMPORTED_MODULE_2__["actionByTypeToPlaceholder"][Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getUpperCaseFirstLetter"])(type)]} ${city}</h3>
...
class Event extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(point) {
    super();
  ...
  switch (legendName) {
    ...
    case LegendName.TIME:
      return labels.map((label) => ({
        ...
        .reduce((acc, curr) => acc + Math.round(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(curr.end - curr.start, `milliseconds`) / (60 * 60 * 1000)), 0)
      }))
      .filter((point) => point.value !== 0)
      .sort((a, b) => b.value - a.value);
    default:
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: routeTypes, actionByTypeToPlaceholder, sortOptions, FilterType, DefaultData, DuringData, Keys */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "routeTypes", function() { return routeTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "actionByTypeToPlaceholder", function() { return actionByTypeToPlaceholder; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DuringData", function() { return DuringData; });
...
const actionByTypeToPlaceholder = {
  'Taxi': `to`,
  'Bus': `to`,
  'Train': `to`,
  'Ship': `to`,
...
/* harmony import */ var _info_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./info-controller.js */ "./src/controllers/info-controller.js");
/* harmony import */ var _models_points_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/points.js */ "./src/models/points.js");
...
/* harmony import */ var _statistics_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./statistics-controller.js */ "./src/controllers/statistics-controller.js");
/* harmony import */ var _trip_controller_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./trip-controller.js */ "./src/controllers/trip-controller.js");
...
class AppController {
  constructor() {
    ...
    this._siteMenu = new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._pointsModel = new _models_points_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._tripController = new _trip_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](tripEventsElement, this._pointsModel, this._api);
    this._filterController = new _filter_controller_js__WEBPACK_IMPORTED_MODULE_1__["default"](tripControlsElement, this._pointsModel);
    this._infoController = new _info_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripInfoBlockElement, this._pointsModel);
    this._statisticsController = new _statistics_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](tripEventsElement, this._pointsModel);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["renderElement"])(tripControlsElement, this._siteMenu, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
  }
  ...
  _setSiteNavigation() {
    this._siteMenu.setOnChange((item) => {
      switch (item) {
        case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].TABLE:
          this._siteMenu.setActiveItem(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].TABLE);
          this._tripController.show();
          this._statisticsController.hide();
          break;
        case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].STATS:
          this._siteMenu.setActiveItem(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].STATS);
...
class FilterController {
  ...
  render() {
    ...
    if (oldComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(container, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
...
class InfoController {
  ...
  render() {
    ...
    this._infoComponent = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._pointsModel);

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._infoComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(container, this._infoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
    }
  }
...
/* harmony import */ var _models_point_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/point.js */ "./src/models/point.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _models_store_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/store.js */ "./src/models/store.js");
...
const parseFormData = (formData) => {
  ...
  const destination = _models_store_js__WEBPACK_IMPORTED_MODULE_6__["default"].getDestinations().find((city) => city.name === formData.get(`event-destination`));

  return new _models_point_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
    'base_price': Number(formData.get(`event-price`)),
    'date_from': new Date(
        moment__WEBPACK_IMPORTED_MODULE_0___default()(formData.get(`event-start-time`), `DD/MM/YYYY HH:mm`).valueOf()
    ).toISOString(),
    'date_to': new Date(
        moment__WEBPACK_IMPORTED_MODULE_0___default()(formData.get(`event-end-time`), `DD/MM/YYYY HH:mm`).valueOf()
    ).toISOString(),
    'destination': {
...
class PointController {
  ...
  render(_point, mode) {
    ...
    this._eventComponent = new _components_event_js__WEBPACK_IMPORTED_MODULE_2__["default"](_point);
    this._eventEditComponent = new _components_event_edit_js__WEBPACK_IMPORTED_MODULE_3__["default"](_point);
    ...
    this._eventEditComponent.setSubmitHandler((evt) => {
      ...
      this._eventEditComponent.setData({
        saveButtonText: _const_js__WEBPACK_IMPORTED_MODULE_1__["DuringData"].SAVE_BTN,
      });
    ...
    this._eventEditComponent.setDeleteButtonClickHandler((evt) => {
      ...
      this._eventEditComponent.setData({
        deleteButtonText: _const_js__WEBPACK_IMPORTED_MODULE_1__["DuringData"].DELETE_BTN,
      });
      this._eventEditComponent.disableForm();
    ...
    this._eventEditComponent.setFavoritesButtonClickHandler(() => {
      const newPoint = _models_point_js__WEBPACK_IMPORTED_MODULE_4__["default"].clone(_point);
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldEventComponent && oldEventEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._eventComponent, oldEventComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._eventEditComponent, oldEventEditComponent);
          this._replaceEditToTask();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._eventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.CREATING:
        if (oldEventComponent && oldEventEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldEventComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldEventEditComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._eventEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREBEGIN);
        break;
    }
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._eventEditComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._eventComponent);
  ...
  shake() {
    ...
    setTimeout(() => {
      ...
      this._eventEditComponent.setData({
        saveButtonText: _const_js__WEBPACK_IMPORTED_MODULE_1__["DefaultData"].SAVE_BTN,
        deleteButtonText: _const_js__WEBPACK_IMPORTED_MODULE_1__["DefaultData"].DELETE_BTN,
      });
  ...
  _replaceTaskToEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._eventEditComponent, this._eventComponent);
  ...
  _replaceEditToTask() {
    ...
    if (document.contains(this._eventEditComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._eventComponent, this._eventEditComponent);
    }
    this._mode = Mode.DEFAULT;
  }

  _onEscKeyDown(evt) {
    const isEscKey = evt.key === _const_js__WEBPACK_IMPORTED_MODULE_1__["Keys"].ESCAPE || evt.key === _const_js__WEBPACK_IMPORTED_MODULE_1__["Keys"].ESC;
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_statistics_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/statistics.js */ "./src/components/statistics.js");
...
class StatisticsController {
  ...
  render() {
    ...
    this._statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._pointsModel);

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._statisticsComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(container, this._statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND);
    }
  }
}
...
/* harmony import */ var _components_loading_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/loading.js */ "./src/components/loading.js");
/* harmony import */ var _point_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./point-controller.js */ "./src/controllers/point-controller.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
const renderPoints = (points, container, onDataChange, onViewChange, isDefaultSorting = true) => {
  ...
  dates.forEach((date, dateIndex) => {
    const day = isDefaultSorting
      ? new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"](date, dateIndex + 1)
      : new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"]();

    points.filter((_point) => {
      return isDefaultSorting ? new Date(_point.start).toDateString() === date : _point;
    }).map((_point) => {
      const pointController = new _point_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](day.getElement().querySelector(`.trip-events__list`), onDataChange, onViewChange);
      pointController.render(_point, _point_controller_js__WEBPACK_IMPORTED_MODULE_4__["Mode"].DEFAULT);
      pointControllers.push(pointController);

      return pointController;
    });

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(container.getElement(), day, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  });
...
class TripController {
  constructor(container, pointsModel, api) {
    ...
    this._loading = new _components_loading_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._noTasksComponent = new _components_no_tasks_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._sortComponent = new _components_sorting_js__WEBPACK_IMPORTED_MODULE_6__["default"](_const_js__WEBPACK_IMPORTED_MODULE_7__["sortOptions"]);
    this._daysContainer = new _components_days_list_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  render() {
    ...
    if (points.length === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._noTasksComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._daysContainer, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  ...
  rerender() {
    this._sortComponent.setSortType(_components_sorting_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT);
    this._updatePoints();
  ...
  createPoint() {
    ...
    this._creatingPoint = new _point_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._daysContainer.getElement(), this._onDataChange, this._onViewChange);
    this._creatingPoint.render(_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["EmptyPoint"], _point_controller_js__WEBPACK_IMPORTED_MODULE_4__["Mode"].CREATING);
    this._onViewChange();
  }

  isLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._loading, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }

  isLoaded() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._loading);
  }
  ...
  _onDataChange(pointController, oldData, newData) {
    if (oldData === _point_controller_js__WEBPACK_IMPORTED_MODULE_4__["EmptyPoint"]) {
      this._creatingPoint = null;
      if (newData === null) {
...
const app = new _controllers_app_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
app.render();
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomArrayItem, getRandomIntegerNumber, getDurationTime, clearString, getUpperCaseFirstLetter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearString", function() { return clearString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUpperCaseFirstLetter", function() { return getUpperCaseFirstLetter; });
...
const getDurationTime = (timeInMs) => {
...
const getUpperCaseFirstLetter = (type) => {
  return (
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getPastPoints, getFuturePoints, getPointsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, createElement, renderElement, replace, remove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createElement = (template) => {
  ...
  element.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_0___default.a.sanitize(template);
